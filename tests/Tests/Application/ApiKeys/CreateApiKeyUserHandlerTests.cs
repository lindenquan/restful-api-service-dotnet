...
namespace Tests.Application.ApiKeys;
...
public class CreateApiKeyUserHandlerTests
{
    ...
    [Fact]
    public async Task Handle_AdminUser_ShouldSetCorrectUserType()
    {
        // Arrange
        var command = new CreateApiKeyUserCommand(
            UserName: "admin-user",
    ...
    [Fact]
    public async Task Handle_ShouldGenerateUniqueApiKeyForEachUser()
    {
        // Arrange
        var callCount = 0;
